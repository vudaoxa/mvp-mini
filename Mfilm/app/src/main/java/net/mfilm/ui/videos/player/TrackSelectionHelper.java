 ...
 */
package net.mfilm.ui.videos.player;
...
public class TrackSelectionHelper implements View.OnClickListener,
    ...
    private View buildView(Context context) {
        ...
        View view = inflater.inflate(R.layout.vtrack_selection_dialog, null);
        ...
        root.addView(inflater.inflate(R.layout.vlist_divider, root, false));
