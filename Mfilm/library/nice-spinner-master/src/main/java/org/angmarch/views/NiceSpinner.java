...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setPadding(resources.getDimensionPixelSize(R.dimen.one_and_a_half_grid_unit), defaultPadding, 0, defaultPadding);
        setClickable(true);
        setBackgroundResource(R.drawable.selector);
        setTextColor(getResources().getColor(R.color.ns_item_text_color));
        ...
        mPrompt = typedArray.getString(R.styleable.NiceSpinner_nsp_prompt);
        if (!mHideArrow) {
